...
export default function Home() {
  ...
  async function obterPessoa(){
    const resp = await fetch("http://localhost:3002/pessoa")
    const Pessoa = await resp.json()
    setPessoas(Pessoa)
  }

  async function criarPessoa() {
    await fetch('http://localhost:3002/pessoa', {
      method: 'POST',
      headers: {
  ...
  async function alterarPessoa() {
    await fetch('http://localhost:3002/pessoa/' + id, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async function obterPessoaPorId(id: any) {
    ...
    const res = await fetch("http://localhost:3002/pessoa/" + id)
